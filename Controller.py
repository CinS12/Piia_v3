...
class Controller:
    ...
    def __init__(self, parent):
        ...
        pub.subscribe(self.image_size_ok, "IMAGE_SIZE_OK")
    ...
    def ask_roi_confirmation(self, img_cv2_mask, img_cv2_roi, tissue, scale_factor, px_perimeter, ring):
        ...
        try:
            ...
            self.view.ask_roi_confirmation(img_cv2_mask, img_cv2_roi, tissue, scale_factor, ring)
        except:
            self.view.popupmsg("Alguna cosa ha fallat. Torna-ho a intentar!")
    ...
    def roi_granulation(self):
        ...
        self.view.ask_zone_type("Granulation")
    ...
    def roi_necrosis(self):
        ...
        self.view.ask_zone_type("Necrosis")
    ...
    def roi_slough(self):
        ...
        self.view.ask_zone_type("Slough")
    ...
    def roi_confirmated(self, img_cv2_roi, tissue, ring):
        ...
        self.view.updateLabelGUI(self.pressure_img.mask)
        if(ring == 0):
            #Zona tancada
    ...
    def whitebalance(self, img_cv2_mask):
        ...
        if self.pressure_img.whitebalanced == False:
                ...
                self.view.ask_whitebalance_confirmation(img_cv2_mask, img_whitebalanced)
        else:
    ...
    def whitebalance_confirmated(self, img_cv2_whitebalanced):
        ...
        self.view.update_whitebalanced_label(img_cv2_whitebalanced)
    ...
    def image_accepted(self):
        ...
        self.pressure_img.close_all()
        self.view.update_main_label(self.pressure_img.mask)
    ...
    def image_size_ok(self, image_cv2):
        print("controller - image_size_ok")
